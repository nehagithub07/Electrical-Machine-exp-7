...
const LAB_VOICE_CATALOG = [
  ...
  { key: "step_pointA2-pointF2", text: "Connect point A 2 to point F 2.", audio: "./audio/step_pointA2-pointZ2.wav" },
  ...
  { key: "step_pointF-pointF1", text: "Connect point F to point F 1.", audio: "./audio/step_pointF-pointZ1.wav" },
  { key: "step_pointA4-pointL2", text: "Connect point L 2 to point A 4.", audio: "./audio/step_pointA4-pointL2.wav" },
  { key: "step_pointA4-pointF4", text: "Connect point A 4 to point F 4.", audio: "./audio/step_pointA4-pointZ4.wav" },
  { key: "step_pointF4-pointK", text: "Connect point F 4 to point K.", audio: "./audio/step_pointK-pointZ4.wav" },
  ...
  { key: "step_pointF3-pointH", text: "Connect point H to point F 3.", audio: "./audio/step_pointH-pointZ3.wav" }
];
