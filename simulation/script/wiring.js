...
function setupJsPlumb() {
  ...
  const WIRE_CURVE_OVERRIDES = new Map([
    ...
    [connectionKey("pointB", "pointF2"), 130],
    [connectionKey("pointF", "pointI"), 100],
    [connectionKey("pointA", "pointA1"), 95],
    [connectionKey("pointH", "pointF1"), 115],
    [connectionKey("pointC", "pointA3"), 85],
    [connectionKey("pointD", "pointA4"), 90],
    [connectionKey("pointE", "pointF3"), 100],
    [connectionKey("pointG", "pointF4"), 120],
  ...
  const pinnedSelectors = [
    ...
    ".point-A1", ".point-F1", ".point-A2", ".point-F2", ".point-A3", ".point-F3", ".point-A4", ".point-F4",
    ".point-L1", ".point-L2"
  ];
